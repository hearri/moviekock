...
public class UserAddCoverCommand implements CommonMapCommand {
	...
	public Map<String, Object> execute(SqlSession sqlSession, Model model) {
		...
		MultipartFile file = multipartRequest.getFile("userCover");
		...
		if(file != null && !file.isEmpty()) {
			...
			String realPath = multipartRequest.getServletContext().getRealPath("assets/images/userCover");
			...
			if(dao.userAddCover(uploadFilename, userNo) > 0) {
				System.out.println(uploadFilename);
